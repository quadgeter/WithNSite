...
export const deploy = async (options, command) => {
    ...
    if (!siteId) {
        return logAndThrowError("Unable to determine which site to deploy to. Make sure you've run 'netlify link' or that you're specifying your desired site using the '--site' option.");
    }
